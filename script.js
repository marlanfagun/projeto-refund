...
function expenseAdd(newExpense) {
  try {
    ...
    //Limpa os inputs para adicionar outro item
    formClear()
...
function updateTotals() {
  try {
    ...
    //Formata o valor e remove o R$ para exibí-lo pela small customizado por CSS
    total = formatCurrencyBRL(total).toUpperCase().replace("R$", "")

    //Limpa o conteúdo do elemento
    expenseTotal.innerHTML = ""

    //Adiciona o symbolo da moeda e o valor total
